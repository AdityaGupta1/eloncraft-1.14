...
public class ModOreFeature extends Feature<ModOreFeatureConfig> {
    public ModOreFeature(Function<Dynamic<?>, ? extends ModOreFeatureConfig> p_i51472_1_) {
        super(p_i51472_1_);
    }
                                ...
                                for(int j2 = l; j2 <= k1; ++j2) {
                                    ...
                                    if (d8 * d8 + d9 * d9 + d10 * d10 < 1.0D) {
                                        ...
                                        if (!bitset.get(k2)) {
                                            ...
                                            if (config.matcher.matches(worldIn.getBlockState(blockpos$mutableblockpos))) {
                                                worldIn.setBlockState(blockpos$mutableblockpos, config.ore, 2);
                                                ++i;
                                            }
                                        }
                                    }
